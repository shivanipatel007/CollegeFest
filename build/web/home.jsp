...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="#sponser">our Sponsor</a></li>
        ...
        <section id="contact-about">
            <div class="about">
                ...
                <div class="detail">
                    ...
                    <h1>Eclectika 2023</h1>
                    <h1><a href="register.jsp" target="_blank">Register Here</a></h1>
                    <h1>College :National Institute Of Technology, Raipur ,492001</h1>
                    <h1>Phone :7770977776</h1>
                </div>
                <div class="links">
        ...
        <footer>
            <div id="footer_box">
                Copyright &copy; www.Eclectika2023.com All rights reserved!
            </div>
        </footer>
